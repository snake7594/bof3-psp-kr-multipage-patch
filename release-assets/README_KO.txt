...
v0.4의 시작 직후 크래시를 피하기 위해 FIRST.EMI와 BATL_RET.EMI는 원본 크기와 섹션 수를 유지합니다.
...
4. BOF3_KR_fontimage_v0.4.1-alpha.iso 파일이 생성됩니다.

주의

- 이 패치는 PSP판 Breath of Fire III 원본 ISO용입니다.
- 원본 ISO MD5는 C7081C9C0865ECAEB6F4D2A42F865528 입니다.
- 생성 후 ISO MD5는 CF9AC1D9061203F20F51DF97BA5B9DF1 입니다.
- 일본어 한자가 그대로 보이던 v0.3 문제를 줄이기 위해 BOOT.BIN과 보조 폰트 파일을 함께 패치했습니다.
- v0.4에서 커진 FIRST.EMI 때문에 시작 직후 크래시가 날 수 있어, 이번 버전은 해당 파일을 키우지 않습니다.
